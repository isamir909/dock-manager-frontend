              ...
              <li>
                {
                  <div className="card">
                    ...
                    <img
                      className="image"
                      src={require(`../../assets/images/${element.extension}.jpg`)}
                      alt={document.file}
                    />
                    <article> {element.fileName}</article>
                    <br />
                    <div className="bttn">
                      <button onClick={() => viewProduct(element.fileLink)}>
                        View
                      </button>
                      <button
                        onClick={() => nav(`/document/${element._id}/to-text`)}
                      >
                        convert to text
                      </button>
                      <button onClick={() => deleteDocument(element._id)}>
                        Delete
                      </button>
                    </div>
                  </div>
